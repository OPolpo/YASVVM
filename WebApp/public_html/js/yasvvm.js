    ...
    $.ajax(
    {
        ...
        success: function(output)
        {
            ...
            else
            {
                ...
                {
                    //$("#job"+id).remove();
                    $("#job"+id).empty().append("JobId: "+id+", UNUSED</div>").hide();
                ...
                else
                {
                    ...
                    {
                        //console.log(result);
                        $("#job"+id).empty().append("JobId: "+id+", "+result.data.executed+" scaricate su "+result.data.total+"</div>").show();
                        setTimeout(function(){checkJobData(id);}, 500);
                    }
                    else
                    {
                        $("#job"+id).empty().append("JobId: "+id+", FINISHED</div>").show();
                ...
                success: function(output)
                {
                    $.ajax(
                    {
                        ...
                        /*success: function(output2)
                        {
                            console.log("ok:");
                            console.log(output2);
                            alert("Il lavoro: "+thisJobId+"è stato completato");
                        },*/
